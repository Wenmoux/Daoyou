...
import fishingRouter from '@server/routes/api/fishing.router';
import fishingEconomyRouter from '@server/routes/api/fishing-economy.router';
...
import spiritPondRouter from '@server/routes/api/spirit-pond.router';
...
apiRouter.route('/fishing', fishingRouter);
apiRouter.route('/fishing-economy', fishingEconomyRouter);
...
apiRouter.route('/spirit-pond', spiritPondRouter);
